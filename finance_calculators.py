...
print("Welcome to the Finance Calculator" + "\n\n" +
      "Choose either 'Investment calculator' or 'Bond calculator' from the menu below to proceed" + "\n\n" +
      "Investment calculator - this will calculate the interest you will receive on an investment" + "\n" +
      "Bond calculator - this will calculate the ammount you will have to pay on a home loan" + "\n")

# This will capture user input and convert all variables of how 'investment' and 'bond' may be spelt and converts it to lower case 
...
# user is asked to confirm 3 variables - intial investment, interest rate and investment age/duration
    ...
    if interest_type == "compound": # A = P* math.pow((1+r),t)
        ...
        interest_rate = float(input("Kindly confirm the interest rate number without the % sign   \n"))
